...
module.exports = {
    ...
    .setName("queue")
    .setDescription("Affiche la file d'attente des musiques en cours")
    ...
    run: async ({ client, interaction }) => {
        ...
        if (page > totalPages) 
            return await interaction.editReply(`Page invalide. There are only a total of ${totalPages} pages of songs`)
