...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("jump")
    .setDescription(
      "Accédez à une musique spécifique dans la file d'attente sans supprimer d'autres musiques"
    )
    .addNumberOption((oprion) =>
      oprion
        .setName("index")
        .setDescription(
          "Entrez le numéro de la musique que vous souhaitez passer"
        )
        .setRequired(true)
    ),
